...
public class Felge {
    ...
    public boolean equals(Object obj){
        ...
        return ((this.id == felgeObj.getId()) && (this.beschreibungID == felgeObj.getBeschreibungID()) &&
                (this.preis == felgeObj.getPreis()) && (this.reifengroesse == felgeObj.getReifengroesse()) &&
                (this.formTyp == felgeObj.getFormTyp()) && (this.formTypID == felgeObj.getFormTypID()) &&
                (this.bild == felgeObj.getBild()) && (this.name == felgeObj.getName()) &&
                (this.narbendynamo == felgeObj.isNarbendynamo()));
    }
