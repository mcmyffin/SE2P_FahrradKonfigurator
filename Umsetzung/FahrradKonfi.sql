...
--
-- Host: localhost
-- Erstellungszeit: 26. Jun 2015 um 09:50
...
(1, 'Dieser Rahmen wurde speziell auf die Wünsche eines gemütlichen Fahrers zugeschnitten. Die einmalig schnittige Form, macht den Rahmen zu dem Besten seiner Klasse, eigentlich schon eine eigene Klasse für sich.\r\nWenn Sie es liebten, sich in aller Ruhe und Entspannung auf den Weg zu machen, so haben Sie Ihren Rahmen gefunden.', 'Gemütliches Fahrrad zum Fahren in der Stadt oder auf der Bundesbahn.\r\nGenießen Sie das Schöne Wetter und fahren Sie ihrem Ziel entgegen.'),
(2, 'Die einzigartige Arluminiumstahllegierung hilft dem Rahmen, doch leicht zu sein, aber auch viel auszuhalten. Niemand wird es je schaffen, diesen Rahmen zu biegen oder zu brechen (es sei denn es handelt sich um ein Auto, LKW, Motorrad, Motorboot, Segelboot, Lastkran, LF16, LF20, SW, Fußgänger, Steinchen, Steine, Meteoren, Pacman, Bilderrahmen, Glas, Laptops, Banken, Geldscheinen [Vorzugweise 500er Scheine], sowie alle Dingen, die mit Kohlenstoff oder dem Periodensystem der Elemente zu tun haben). Das einmalige Design (Made with Paint form MiniSoft Doorswof) bietet die volle Unterstützung auf allen ihren Fahrten.', 'Das sportliche Fahrrad für lange Wegstrecken.\r\nWindschnittig und leicht.'),
(3, 'Ein wahrer Klassiker, kein Mountainbike Rahmen wurde öfter verkauft, laut einer Umfrage (5 von 9 befragten kauften diesen Rahmen). Es ist einer der stabilsten Rahmen auf dem Markt, keiner kann ihm widerstehen, keiner kann sich ihm widersetzen. Mit seinen 30kg Eigengewicht, zerstört er noch so störrische Äste auf dem Weg oder auch Fußgänger.\r\nHergestellt von RahmendotCorp in einer kleinen Holzhütte in Neuseeland aus alten Einkaufwagen, was will man mehr?', 'Der Klassiker unter den Bergfahrern. \r\nStabil, gefedert, dicke Reifen.'),
(4, 'Was ist besser als das Alte? Natürlich das Neue. Neue Aerodynamik, neue Dämpfer, einfach ein neues Erlebnis auf Feld, Wiese und Bergen. Fahren Sie ihre Lieblingsstrecke mit neuen Geschwindigkeiten. Im Gegensatz zu unserem Klassik-Modell wiegt dieser Rahmen nur 15kg, das ist ein Ersparnis von 50% des Gewichtes.', 'Das neue Modell.\r\nBessere Aerodynamik, bessere Dämpfung.'),
(5, 'Sie kennen ihre sanfte Federung von ihrem Kissen und wünschten sich, ihr Fahrrad könnte das Gleiche? Dank der neuen FederSanftTM Technologie von SanfteFederFürAlleUndDichOhneNachteile, ist das möglich. Vergessen Sie die alten Methoden über Ölbeckenfederung oder Luftfederung. Diese Technologie greift auf Ökologisch produzierte Gänsefedern zurück (die Gänse wachsen glücklich auf!), und baut Sie mittels eines einzigartigen Konstrukts in die Gabel ein. So sorgen diese Feder hier, wie auch in ihrem Bett oder sonst wo für eine Sanfte Federung.', 'Neue FederSanftTM Technologie.\r\nRustikal, robust, stabil, unzerstörbar, gefedert (mit Gänsefedern).'),
...
(10, 'Ein neuer Mantel, mit alter Technologie. Doch alt ist doch nicht schlimm, sondern sehr oft auch besser. Dies trifft sicherlich auf diesen Mantel zu. Er besteht aus einer geheimen Mixtur aus verschiedenen Gummisorten (alte Autoreifen bevorzugt). Der größte Vorteil bleibt dennoch die Unplattbarkeit des Reifens. Dieser benötigt keinen Schlauch mehr, sondern besteht nur aus dem Mantel. Der Mantel selbst ist vollgummi. So ersparen Sie sich das lästige nach Hause schieben mit einem platten Reifen. Durch die Dauerhafte Festigkeit des Mantels haben Sie auch einen sehr geringen Rollwiderstand, der das zusätzliche Gewicht ausgleicht.', 'Unplattbar (manchmal), kein aufpumpen mehr.\r\nGeringer Rollwiederstand.'),
(11, 'Mit der neuen Schneeketten Technologie für Fahrradmäntel sind Sie auch für den Tiefsten Winter ausgestattet. Die befestigten Schneeketten, sorgen für halt auf jedem Eis. Aus rechtlichen Gründen sollten Sie aber meiden, nicht vereiste Wege damit zu benutzen.', 'Selbst im Winter schnell.\r\nStoppbar, auch auf Eis.'),
(12, 'Der Standard auf jedem besseren Tourenrad. Dieser Mantel bietet viel Sicherheit auf vielen Touren rund um den Globus. Er rollt nicht nur gut, sondern ist mit vielen Wassern gewaschen. Eine extra 3mm dicke Zusatzschicht bietet zusätzlichen Schutz vor den Übeln der Straße.', 'Schnell leicht, Dick.\r\nIn vielen Fällen unplattbar.'),
...
(15, 'Ein höchst fortschrittlicher Helm, der Sie in jeder Lebenslage schützt vor jedem Schaden (am Kopf. Bitte beachten Sie, dass evtl. Unfälle trotz des Helms tödlich enden können. Dieser Helm dient lediglich zur Schau und bietet keine Sicherheit auf regulären Fahrten.)', 'Sicher unterwegs.\r\nLeicht und stabil.'),
(16, 'Dieser stylische Lenker, welcher in Holland (Niederlande) designt wurde, ist das Absolute must have'' bei jeden Stadtrad. Auch wenn sein Gewicht (mit 10kg) relativ hoch ist, so bietet er die nötige Standfestigkeit, um auch gegen LKW zu bestehen. Evtl. sollte man aber mit der Vorderbremse aufpassen...', 'Stadttauglich, design in Holland.\r\nAuf jeder Straße ein must have''.');
