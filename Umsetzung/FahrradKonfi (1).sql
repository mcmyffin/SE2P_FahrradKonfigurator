...
--
-- Host: localhost
-- Erstellungszeit: 26. Mai 2015 um 09:13
...
INSERT INTO `GabelT` (`G_ID`, `G_bild`, `G_BESCH`, `G_formTyp`, `G_formTypID`, `G_schaftlaenge`, `G_steuersatz`, `G_felgenbrems`, `G_scheibenbrems`, `G_licht`, `G_reifengroesse`, `G_preis`, `G_name`) VALUES
(1, '', 5, 18, 5, 400, 18, 1, 1, 1, 26, 120, 0),
(2, '', 6, 18, 6, 400, 18, 1, 0, 1, 28, 130, 0),
(3, '', 7, 1, 7, 300, 1, 1, 0, 1, 28, 30, 0);
...
INSERT INTO `RahmenT` (`R_ID`, `R_hoehe`, `R_form`, `R_reifengroesse`, `R_bild`, `R_BESCH`, `R_steuersatz`, `R_schafthoehe`, `R_zusatzbefest`, `R_scheibenbrems`, `R_felgenbrems`, `R_tretlager`, `R_formTyp`, `R_formTypID`, `R_name`, `R_preis`, `R_gepaektraeger`, `R_licht`) VALUES
(2, 50, 0, 28, '', 1, 1, 150, 2, 0, 1, 1, 0, 1, 'Gemütliches Cittybike', 200, 1, 1),
(4, 50, 0, 28, '', 2, 18, 150, 1, 1, 0, 1, 2, 2, 'Arlu', 200, 0, 1),
(5, 47, 0, 26, '', 3, 18, 200, 0, 1, 0, 2, 1, 3, 'Mounti Mount', 300, 0, 0),
(6, 45, 0, 26, '', 4, 18, 250, 2, 1, 0, 1, 1, 4, 'Mounti Neu Mount', 350, 0, 0);
