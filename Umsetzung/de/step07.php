...
<div id="infobox-bg">
	<div id="infobox">
		...
		<form action="index.php?section=step07#form">
			<select size="1">
				<option>Bequem</option>
				<option>Sport</option>
			</select><br /><br />
		</form>
		Im <a href="index.php?section=step08">nächsten Schritt</a> wählen Sie die Beleuchtung aus.<br /><br />
	</div>
</div>
<div id="menu">
	<div id="info">
	...
	<div id="next"><a href="index.php?section=step08"><img alt="Next" src="de/get/next.png" /></a></div>
</div>