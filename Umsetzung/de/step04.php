...
<div id="infobox-bg">
	<div id="infobox">
		<b>Fahrradgabel:</b><br /><br />
		Sie haben die Auswahl zwischen:<br /><br />
		<form action="index.php?section=step04#form">
			<select size="1">
				<option>Stargabel</option>
				<option>Federgabel</option>
			</select><br /><br />
		</form>
		Im <a href="index.php?section=step05">nächsten Schritt</a> wählen Sie den Reifen aus.<br /><br />
	</div>
</div>
<div id="menu">
	<div id="info">
	...
	<div id="next"><a href="index.php?section=step05"><img alt="Next" src="de/get/next.png" /></a></div>
</div>