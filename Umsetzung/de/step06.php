...
<div id="infobox-bg">
	<div id="infobox">
		<b>Schaltungstyp:</b><br /><br />
		Sie haben die Auswahl zwischen:<br /><br />
		<form action="index.php?section=step06#form">
			<select size="1">
				<option>fiktiv 1</option>
				<option>fiktiv 2</option>
				<option>fiktiv 3</option>
			</select><br /><br />
		</form>
		Im <a href="index.php?section=step07">nächsten Schritt</a> wählen Sie den Sattel aus.<br /><br />
	</div>
</div>
<div id="menu">
	<div id="info">
	...
	<div id="next"><a href="index.php?section=step07"><img alt="Next" src="de/get/next.png" /></a></div>
</div>